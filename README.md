...
This service probes devices using the Blackbox Prometheus module https://gitlab.playcourt.id/telkom-digital/dpe/std/impl/netmonk/prometheus-exporter. You can configure the devices to probe by adding entries to the `probe_config.yaml` file.
